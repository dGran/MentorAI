/* ============================================================
   MentorAI — Iconos compartidos
   Vivían dentro de Catalog, y por eso cursos, rutas e inicio tenían que
   pedirle iconos al catálogo. Aquí no dependen de nadie.
...
(function () {
  ...
  MentorAI.Icons = {
    for: (key) => TOPIC[key] ?? TOPIC.default,
    clock:
