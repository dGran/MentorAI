...
function buildPrompt(params) {
  ...
  return [
    ...
    "  ../tutorials/manifest.js NO hace falta; sí los ../assets/js/modules/*.js",
    "  (en el mismo orden que la plantilla, init.js el último) y la hoja",
...
function buildRefinePrompt(currentHtml, instructions) {
  return [
    ...
    "- data-lang admitidos: php, bash, ini.",
    "- Cada <h2 id=\"x\"> debe tener su entrada en .toc__list con href=\"#x\".",
    "- Mantén las rutas ../assets/css/styles.css y los ../assets/js/modules/*.js.",
    "- No añadas dependencias externas nuevas.",
    "",
    "HTML ACTUAL:",
    "<<<HTML",
